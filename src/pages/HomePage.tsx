            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg mb-6">
                  I am an artist passionate about capturing the essence of life
                  through vibrant colors and expressive brushstrokes. With over
                  15 years of experience, my work has been featured in galleries
                  across the country.
                </p>
                <p className="mb-8">
                  My journey began with a fascination for how light plays with
                  shadows, creating an ever-changing landscape of colors. This
                  exploration has led me to develop a unique style that bridges
                  classical techniques with contemporary themes.
                </p>
                <button
              ...
              <div>
                <img
                  src="/assests/images/artiest-drawing.png"
                  alt="Artist at work"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-neutral-600">
                  Unique pieces created with passion and attention to detail.
                  Each artwork tells a story and captures emotions through color
                  and form.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-neutral-600">
                  Learn various techniques and styles through personalized
                  courses designed for both beginners and advanced students.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-neutral-600">
                  Custom artworks created specifically for your space and
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-primary-200">
                        {testimonial.course || testimonial.type}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-20 bg-accent-500 text-white">
          <div className="container text-center">
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto">
              Whether you're looking for a statement piece or want to learn new
              techniques, I'm here to help you bring your vision to life.
            </p>
